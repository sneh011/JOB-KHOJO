      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold text-white">Job<span className='text-[#6A38C2]'>Search</span></h2>
            <p className="text-sm text-gray-400">© 2024 JobSearch. All rights reserved.</p>
          </div>
